...
const tableData: Transaction[] = [
  ...
  // Thêm các dữ liệu mẫu khác ở đây
];
            ...
            <tr className="bg-[var(--ht-neutral-100-)]">
              ...
              <td className="w-[100px] absolute top-[50%] right-0 translate-y-[-50%]">
                <div className="flex gap-1 p-1">
                  <a
                    href="/hotel-management/deposit-fund/add-receipt"
                  ...
                  <a
                    href="/hotel-management/deposit-fund/add-ayment-slip"
          ...
          <tbody className="text-[14px]">
            {tableData.map((transaction, index) => (
              ...
              >
                ...
                <td className="p-2 text-end">{transaction.amount}</td>
                <td className="p-2 border-l">{transaction.description}</td>
                <td className="p-2">
                  <div className="flex">
