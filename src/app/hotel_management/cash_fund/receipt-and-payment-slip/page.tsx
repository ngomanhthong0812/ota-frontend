...
const ReceiptAndPaymentSlipPage: NextPage<Props> = ({}) => {
  return (
    <div>
      {/* <!-- start Body Content --> */}
        ...
        <table className="w-full rounded-t-[3px] overflow-hidden mt-3">
            ...
            <tr className="bg-[var(--ht-neutral-100-)]">
              <td className="w-[10%] p-2 ">
                <div className="flex items-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 512 512"
                    fontStyle="margin-right: 10px; margin-top: 2px;"
                  >
              ...
              <td className="w-[100px] absolute top-[50%] right-0 translate-y-[-50%]">
                <div className="flex gap-1 p-1">
                  <Link
                    href="/hotel-management/cash-fund/add-receipt"
                  ...
                  <Link
                    href="/hotel-management/cash-fund/add-inventory"
          ...
          <tbody className="text-[14px]">
            <tr className="group border-b !border-[var(--ht-neutral-100-)]">
              ...
              <td className="p-2 text-center">5,000,000</td>
              <td className="p-2 border-l">
                thonngo@123 nhận đặt cọc VND 5,000,000(Chuyển khoản NH) cho
                phòng 103
              </td>
            ...
            <tr className="group border-b !border-[var(--ht-neutral-100-)] bg-[#f8f8f8]">
              <td className="p-2">
                <p>09/10/2024</p>
                <p>16:18:58</p>
              </td>
