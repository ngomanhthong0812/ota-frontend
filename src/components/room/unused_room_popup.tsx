...
interface IProps {
    ...
    handleBookingClick: () => void; // Accept the function as a prop
}

const UnusedRoomPopup: React.FC<IProps> = ({ ref, showPopup, clean_status, position, handleBookingClick }) => {
    ...
    return (
        <div
            ...
            <ul>
                <li onClick={handleBookingClick} className="popup-item">
