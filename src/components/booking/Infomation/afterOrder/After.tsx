        ...
        <section className="grid grid-cols-2 col-span-7 duration-300 border relative border-[var(--ht-neutral-100-)] bg-white rounded-md">
            ...
            <div className="px-3 border-r border-[var(--ht-neutral-100-)]">
                ...
                <div className=" flex mt-3 relative gap-3 items-center">
                    ...
                    <input type="text" id="SĐT" name="SĐT" placeholder="Mã hiển thị đoàn" className="btn" />

                </div>
                <div className="my-3">
                    <textarea id="notes" name="notes" rows={3} className="btn min-h-[88px]" placeholder="Ghi chú "></textarea>
                </div>
                <div className="flex items-center w-[100%] gap-1 ">
                    <select id="country" name="country" className="btn appearance-none">
            ...
            <div className="px-3">
                ...
                <div className="flex gap-1 my-3">
                    ...
                    <div className="flex-1 flex rounded-md overflow-hidden bg-[var(--ht-neutral-100-)]">
                        ...
                        <input type="radio" name="gender" id="male" value="male" className="sr-only peer/male" />
                ...
                <div className="relative">
                    <svg xmlns="http://www.w3.org/2000/svg" height="15" width="15" viewBox="0 0 448 512" className="absolute left-1 top-1/2 -translate-y-1/2">
                        <path fill="#9ca3b1"
                    ...
                    <input type="text" id="passport" name="passport" placeholder="Nhập số CCCD/Hộ chiếu" className="btn-border-info" />
                </div>
               
                <div className="flex gap-2 my-3">
                    <div className="w-2/3 relative">
                        <svg xmlns="http://www.w3.org/2000/svg" height="15" width="15" viewBox="0 0 512 512" className="absolute left-1 top-1/2 -translate-y-1/2 text-gray-400">
                            <path fill="#9ca3b1"
                                d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48L48 64zM0 176L0 384c0 35.3 28.7 64 64 64l384 0c35.3 0 64-28.7 64-64l0-208L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z" />
                        </svg>
                        <input type="text" id="Email" name="Email" placeholder="Email" className="btn-border-info" />
                    </div>

                    <div className="w-1/3 relative">
                        <svg xmlns="http://www.w3.org/2000/svg" height="15" width="15" viewBox="0 0 512 512" className="absolute left-1 top-1/2 -translate-y-1/2 ">
                            <path fill="#9ca3b1"
                                d="M164.9 24.6c-7.7-18.6-28-28.5-47.4-23.2l-88 24C12.1 30.2 0 46 0 64C0 311.4 200.6 512 448 512c18 0 33.8-12.1 38.6-29.5l24-88c5.3-19.4-4.6-39.7-23.2-47.4l-96-40c-16.3-6.8-35.2-2.1-46.3 11.6L304.7 368C234.3 334.7 177.3 277.7 144 207.3L193.3 167c13.7-11.2 18.4-30 11.6-46.3l-40-96z" />
                        </svg>
                        <input type="text" id="SĐT" name="SĐT" placeholder="SĐT" className="btn-border-info" />
                    </div>
                </div>
                ...
                <div className="my-3 relative">
                    <svg xmlns="http://www.w3.org/2000/svg" className="absolute left-1 top-1/2 transform -translate-y-1/2 " height="14" width="15.75" viewBox="0 0 576 512">
                        <path fill="#b0b5c1"
                            d="M575.8 255.5c0 18-15 32.1-32 32.1l-32 0 .7 160.2c0 2.7-.2 5.4-.5 8.1l0 16.2c0 22.1-17.9 40-40 40l-16 0c-1.1 0-2.2 0-3.3-.1c-1.4 .1-2.8 .1-4.2 .1L416 512l-24 0c-22.1 0-40-17.9-40-40l0-24 0-64c0-17.7-14.3-32-32-32l-64 0c-17.7 0-32 14.3-32 32l0 64 0 24c0 22.1-17.9 40-40 40l-24 0-31.9 0c-1.5 0-3-.1-4.5-.2c-1.2 .1-2.4 .2-3.6 .2l-16 0c-22.1 0-40-17.9-40-40l0-112c0-.9 0-1.9 .1-2.8l0-69.7-32 0c-18 0-32-14-32-32.1c0-9 3-17 10-24L266.4 8c7-7 15-8 22-8s15 2 21 7L564.8 231.5c8 7 12 15 11 24z" />
                    </svg>
                    <input type="text" id="SĐT" name="SĐT" placeholder="Địa chỉ" className="btn-border-info" />
            ...
            <div className="px-3 rounded-md bg-white border border-[var(--ht-neutral-100-)] mt-2">
                ...
                <div className="flex justify-between mt-3">
                    <div className="center ">
                        <p className="text-black font-medium flex items-cente ">Sea view</p>
                    </div>
                    <div className="flex items-center text-[var(--navbar-color-)] font-medium gap-1 ">
                        <p>400,000</p>
                        <span>x</span>
                        <p>2</p>
                    </div>
